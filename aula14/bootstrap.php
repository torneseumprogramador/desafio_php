      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown" data-bs-theme="light">
              <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="download">Quartz</a>
              <div class="dropdown-menu" aria-labelledby="download">
                ...
                <a class="dropdown-item" href="../5/quartz/bootstrap.rtl.min.css" download>bootstrap.rtl.min.css</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../5/quartz/_variables.scss" download>_variables.scss</a>
                <a class="dropdown-item" href="../5/quartz/_bootswatch.scss" download>_bootswatch.scss</a>
              </div>
            </li>
          </ul>
      ...
      <div class="page-header" id="banner">
        <div class="row">
          <div class="col-lg-8 col-md-7 col-sm-6">
            <h1>Quartz</h1>
            <p class="lead">A glassmorphic layer</p>
          </div>
